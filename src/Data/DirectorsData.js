...
export const directorsData = [
  {
    ...
    bio: 'Supernova is a creative duo known for their visually rich and emotionally driven work. Their style combines cinematic aesthetics with innovative techniques.',
    videos: [
  ...
  },
  {
    ...
    photoSrc: placeholderPhoto,
    bio: 'Christopher Sims is a master of creating captivating narratives. His work often explores human relationships in complex commercial and music video projects.',
    videos: [
  ...
  {
    id: 4,
    name: 'MATTIA BENNETTI',
    slug: 'mattia-bennetti',
    photoSrc: placeholderPhoto,
    bio: 'Mattia Benetti brings a sleek, modern, and fashion-forward perspective to his films, creating visually striking and elegant content.',
    videos: [
  ...
  },
  {
    ...
    slug: 'remy-cayuela',
    photoSrc: placeholderPhoto,
    bio: 'Remy Cayuela excels in comedic storytelling and quirky narratives, bringing a unique and humorous touch to his projects.',
    videos: [
  ...
  },
  {
    ...
    slug: 'lorenzo-cisi',
    photoSrc: placeholderPhoto,
    bio: 'Lorenzo Cisi is a storyteller who focuses on authentic human emotions, creating relatable and heartfelt commercial content.',
    videos: [
  ...
  },
  {
    ...
    slug: 'beedy',
    photoSrc: placeholderPhoto,
    bio: 'Beedy is known for a raw and authentic visual style, often capturing stunning natural landscapes and intimate moments.',
    videos: [
